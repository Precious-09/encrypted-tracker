...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "EncryptedExpenseTracker",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.EncryptedExpenseTracker__factory>;
    getContractFactory(
      name: "MockExpenseTracker",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.MockExpenseTracker__factory>;
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.EncryptedExpenseTracker>;
    getContractAt(
      name: "MockExpenseTracker",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.MockExpenseTracker>;
